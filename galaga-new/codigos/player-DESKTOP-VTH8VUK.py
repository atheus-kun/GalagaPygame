...
class player(pygame.sprite.Sprite):
    def __init__(self,pos,group,bullet,group_bullets_right,group_bullets_left,group_bullet_enemies,group_collide):
        ...
        self.groupCollide = group_collide
        self.pos = pos
        self.reborn = False
        #variables---------------------
    ...
    def health(self,dt):
        ...
        if pygame.sprite.groupcollide(self.groupCollide,self.bullets_enemies_list,False,True)  and self.salud != 0:
            self.salud -= 50
    ...
    def update(self,dt):
        self.collide = collide(self.groupCollide,self.pos)
