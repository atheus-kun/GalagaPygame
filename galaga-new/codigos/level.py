...
from background import Back_manager
class Level:
    ...
    def setup(self):
        ...
        for i in mapa_enemigos_lvl1:
            if i == "x":
                ...
                self.pos_naves[0] = 50
        self.player = player((res[0]/2,650),self.player_sprites,shoots_players,self.bullets_right_sprites,self.bullets_left_sprites,self.bulletsEnemies)
